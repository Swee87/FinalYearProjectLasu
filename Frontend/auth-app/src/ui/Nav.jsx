...
export const Nav = () => {
  return (
    <nav 
      className="fixed w-full bg-gradient-to-r from-gray-800 to-gray-900 shadow-xl p-4 top-0 left-0 z-1000"
      style={{ zIndex: 6000 }} // Explicit for clarity
    >
        ...
        <ul className="flex items-center space-x-8">
          ...
          <li>
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="text-white font-bold text-lg px-6 py-2 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-600 transition-all duration-500 hover:bg-pos-0 bg-pos-100"
              style={{
