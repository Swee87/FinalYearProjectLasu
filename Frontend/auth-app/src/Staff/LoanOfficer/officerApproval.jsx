...
const WORKFLOW = ["pending", "approved", 'processing', 'disbursed'];
...
const LoanRow = React.memo(({ loan, isSelected, onCheckboxChange, onQuickMove }) => {
  ...
  return (
    <tr className="hover:bg-gray-50 transition-colors duration-100">
      ...
      <td className="px-6 py-4 whitespace-nowrap">{loan.approvedAt ? formatDateWithSuffix(loan.approvedAt) : 'N/A'}</td>
      {/* <td className="px-6 py-4 whitespace-nowrap">{loan.dueAt ? formatDateWithSuffix(loan.dueAt) : 'Due Date not set'}</td> */}
    </tr>
  );
});

export function LoanOfficerApproval() {
  ...
  return (
    <div className="container mx-auto p-1">
      ...
      <div className="overflow-x-auto bg-white rounded-lg shadow">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("loanId")}>
                App ID {sortColumn === "loanId" && (sortOrder === "asc" ? "↑" : "↓")}
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("firstName")}>
                First Name {sortColumn === "firstName" && (sortOrder === "asc" ? "↑" : "↓")}
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("lastName")}>
                Last Name {sortColumn === "lastName" && (sortOrder === "asc" ? "↑" : "↓")}
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("loanAmount")}>
                Amount {sortColumn === "loanAmount" && (sortOrder === "asc" ? "↑" : "↓")}
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("monthlySavings")}>
                Monthly Savings {sortColumn === "monthlySavings" && (sortOrder === "asc" ? "↑" : "↓")}
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("bankName")}>
                Bank Name {sortColumn === "bankName" && (sortOrder === "asc" ? "↑" : "↓")}
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("accountNumber")}>
                Account Number {sortColumn === "accountNumber" && (sortOrder === "asc" ? "↑" : "↓")}
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                Account Name
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("phoneNumber")}>
                Phone Number {sortColumn === "phoneNumber" && (sortOrder === "asc" ? "↑" : "↓")}
              </th>
              <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onClick={() => handleSort("createdAt")}>
        ...
        {/* {paginatedData.map((loan)=>{
            <LoanHistory key={loan.loanId} loanId={loan.loanId}/>
        })} */}
      </div>
      ...
      {/* Bulk Actions Footer */}
      <div className="mt-6 flex items-center bg-white p-4 rounded-lg shadow">
        <div className="flex items-center space-x-4">
          <div className="text-sm text-gray-600">
            Bulk Actions:
          </div>
